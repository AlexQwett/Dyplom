...
const Header = () => {
  ...
  return (
    <>
      <div className="topbar border border-gray-800">
        <ul>
          <li>
      ...
      <div className="navbar max-w-7xl mx-auto">
        ...
        <div className="flex-none">
          ...
          <div className="dropdown dropdown-end">
            ...
            <div
              tabIndex={0}
              className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-blue-200 shadow"
            >
              <div className="card-body">
                <span className="font-bold text-lg text-accent-content">
                  {amount} Товарів
                </span>
                <span className="text-info text-accent-content text-gray-800">
      ...
      <div className="navbar-bottom-menu border-y border-gray-800">
        <div className="drawer">
          ...
          <div className="drawer-side z-10">
            ...
            <ul className="menu p-4 w-80 min-h-full bg-blue-200 text-base-content mt-4">
            <label htmlFor="my-drawer" className="btn drawer-button">
