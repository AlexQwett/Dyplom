      ...
      <div className="grid grid-cols-2 max-w-7xl mx-auto mt-5 max-lg:grid-cols-1 max-lg:mx-5">
        ...
        <div className="single-product-content flex flex-col gap-y-5 max-lg:mt-2">
          ...
          <div className="other-product-info flex flex-col gap-x-2">
            <div className="badge bg-sky-700 badge-lg font-bold text-white p-5 mt-2">
              Торгова марка: {productData?.brandName}
            </div>
            <div className="badge bg-sky-700 badge-lg font-bold text-white p-5 mt-2">
              Тварина: {productData?.pet}
            </div>
            <div
              className={
                productData?.isInStock
                  ? "badge bg-sky-700 badge-lg font-bold text-white p-5 mt-2"
                  : "badge bg-sky-700 badge-lg font-bold text-white p-5 mt-2"
              }
            >
              {productData?.isInStock ? "В наявності" : "Немає в наявності"}
            </div>
            <div className="badge bg-sky-700 badge-lg font-bold text-white p-5 mt-2">
              Штрих-код: {productData?.productCode}
            </div>
            <div className="badge bg-sky-700 badge-lg font-bold text-white p-5 mt-2">
